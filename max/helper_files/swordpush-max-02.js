...
/*
  $("#expand-advanced").mouseover(function(){
    if ($("#advanced-message").css("display") == 'none') {
      $("#basic-message").show('fast');
//      $(this).parent()addClass("expert-activated");
    }
  });
  $("#basic-message").mouseout(function(){
    if ($("#advanced-message").css("display") == 'none') {
      $("#basic-message").hide();
      $(this).parent().removeClass("expert-activated");
    }
  });
*/
  ...
  $("#see-error").click(function(){
    ...
    // Show the edit roles form.
    $('#edit-wa').click(function(e) {
        e.preventDefault();
        $('#wa').modal();
    });

    // Hide the edit roles form.
    $('#cancel-wa').click(function(e) {
        e.preventDefault();
        $.modal.close();
    });

    // Apply the changed roles.
    $('#submit-wa').click(function(e) {
        e.preventDefault();
        $.modal.close();
    });
